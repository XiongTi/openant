...
```bash
cat /home/node/.openclaw/openclaw.json | python3 -c "import json,sys; d=json.load(sys.stdin); print(json.dumps(d['models'].get('providers', {}), indent=2))"
```
...
{
  "api_key": "API密钥",
  "output_path": "/home/node/.openclaw/workspace/minimax-output"
}
EOF
```
...
将图片放到可访问路径，例如：
- `/home/node/.openclaw/workspace/images/图片名.jpg`
- 或者使用 URL
...
```bash
python3 /home/node/.openclaw/skills/minimax-understand-image/scripts/understand_image.py <图片路径或URL> "<对图片的提问>"
```
...
```bash
# 描述图片内容
python3 /home/node/.openclaw/skills/minimax-understand-image/scripts/understand_image.py /root/image.jpg "详细描述这张图片的内容"

# 使用 URL
python3 /home/node/.openclaw/skills/minimax-understand-image/scripts/understand_image.py "https://example.com/image.jpg "这张图片展示了什么？"
```
...
脚本位置：`/home/node/.openclaw/skills/minimax-understand-image/scripts/understand_image.py`
